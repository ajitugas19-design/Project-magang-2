              ...
              <div class="modal-body">
                <form action="barang_keluar_act.php" method="post">
                  ...
                  <div id="barcode_info" class="alert alert-info" style="display: none;">
                    ...
                    <p><strong>Stok Tersedia:</strong> <span id="stok_barang"></span></p>
                  </div>
                    ...
                    <select class="form-control" name="barang" id="barang_select" required="required" onchange="fillLokasi()">
                      ...
                      if($barang){
                        while($b=mysqli_fetch_array($barang)){
                          ?>
                          <option value="<?php echo $b['barang_id']; ?>" data-nama="<?php echo $b['barang_nama']; ?>" data-lokasi="<?php echo $b['barang_lokasi']; ?>" data-jumlah="<?php echo $b['barang_jumlah']; ?>"><?php echo $b['barang_nama']; ?> (<?php echo $b['barang_id']; ?>)</option>
                          <?php 
                        }
                      }
                      ?>
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response.success) {
                ...
                $('#stok_barang').text(response.data.barang_jumlah);
                $('#barcode_info').show();
