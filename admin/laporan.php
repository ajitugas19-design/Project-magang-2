...
<a href="laporan_excel.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&jenis=<?php echo $jenis ?>" class="btn btn-sm btn-warning">
<i class="fa fa-file-excel-o"></i> &nbsp EXPORT EXCEL</a>
